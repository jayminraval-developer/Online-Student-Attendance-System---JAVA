...
%>
	<!-- Brand -->
	<img class="bg-light img-fluid" src="images/hngu-logo.png" width="250px"/>
	<a class="navbar-brand" href="after_studentLogin.jsp"><span class="glyphicon glyphicon-home"></span>&nbsp;Home</a>
	<!-- Links -->
	<ul class="navbar-nav container">
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Enquiry/Updation</a>
