	...
	<div class="container-fluid">
		<div class="panel panel-default shadow p-3 mb-5"
			...
			<div class="panel-body">
                            <div class="dname" style="">Department Of Computer Science</div>
				<div class="alert alert-info shadow p-3 mb-5" style="text-transform: uppercase">Welcome To Student Portal</div>
