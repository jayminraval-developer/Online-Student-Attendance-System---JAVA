    ...
    <body style="background-color:#F0F0F0";>
        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-3">
                        <a class="navbar-brand h-25" href="forgetPassword.jsp"><img class="rounded float-start" src="images//hngu-logo.png" width="250px"></a>
                    </div>
                    <div class="col-9">
                        <h2 class="navbar-text pull-right" style="color: black;">Department Of Computer Science,PATAN</h2>
                    </div>
                </div>
            </div>
        </nav>               
                ...
                <div class="panel panel-danger">
                    ...
                    <div style="padding-top: 30px" class="panel-body">
                        ...
                        <form id="loginform" class="form-horizontal" role="form"
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"><i
                                        class="glyphicon glyphicon-envelope"></i> </span> <input id="login-email"
                                                                                         ...
                                                                                         placeholder="Enter your email id" style="height: 40px;">
                            </div>
                            ...
                            <h4><a href="index.jsp"><button type="button" class="btn btn-primary"><b>Go To Login</b></button></a></h4>
